...
const ApplicationListStaffAdvisor=({setCertificates,setAppsno,certificates})=>{
    const {user,setLoading} = useContext(UserContext)
    useEffect(() => {
        axios.get(`${baseUrl}/staffadvisor/viewcertificates`,{params:{user_id:user.user_id}})
        .then(res=>{
        //   console.log("hello")
...
export default ApplicationListStaffAdvisor